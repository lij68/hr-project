...
<meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<body>
		...
		<table class="tbl">
				<tr>
					<td>지원 년도 </td>
					<td><input type="number" id="apply_year" value="2022" /></td>
				</tr>
				<tr>
					<td>지원 기수 </td>
					<td>
			...
			<input type="button" class="jbtn" id = "Reg_btn" value="이력서 지원" /><input type="reset" class="jbtn" id = "cancel_btn" value="초기화" />
			</div>
	</body>
</html>