		...
		function approvalGrid1() {
			...
			gridOptions = {
				...
				onRowClicked: function (event) {
					...
					console.log(detailappointmentList);
				}
			}
		...
		function appointmentInfo() {
			$.ajax({
				...
				success: function (data) {
					...
					let appointment1 = data.infoList;
					console.log(appointment1);
					historyGrid1(appointment1);
				}
			});
		}

		function historyGrid1(appointment1) {
			var columnDefs1 = [
			...
			$('#historygrid1').children().remove();
			var eGridDiv = document.querySelector('#historygrid1');
			new agGrid.Grid(eGridDiv, gridOptions);
			gridOptions.api.sizeColumnsToFit();
		}
		...
		function appointemp(hosu) {
			...
			$.ajax({
				...
				success: function (data) {
					...
					let appointment3 = data.typelist;
					let appointment4 = data.countlist;
					console.log(appointment3);
					console.log(appointment4);
					historyGrid2(appointment3, appointment4);
				}
			});
		}

		function historyGrid2(appointment3, appointment4) {
			console.log(appointment4);
			var columnDefs2 = [
			...
			gridOptions = {
				columnDefs: columnDefs2,
				rowData: [
					{type: "부서이동", count: appointment4.deptChangeStatus},
					{type: "호봉승급", count: appointment4.hobongChangeStatus},
					{type: "승진", count: appointment4.positionChangeStatus},
					{type: "퇴직", count: appointment4.retirementStatus},
					{type: "파견", count: appointment4.dispatchStatus},
					{type: "휴직", count: appointment4.leaveStatus}
				],
				onRowClicked: function (event) {
					let hosu = appointment4.hosu;
			...
			$('#historygrid2').children().remove();
			var eGridDiv = document.querySelector('#historygrid2');
			new agGrid.Grid(eGridDiv, gridOptions);
			gridOptions.api.sizeColumnsToFit();
		}
		...
		function AppointmentType(type, hosu) {
			$.ajax({
				...
				success: function (data) {
					...
					let listtype = data.typelist;
					historyGrid3(listtype, type);
				}
			})
		}

		function historyGrid3(listtype, type) {
			...
			var dispatch = [
				{headerName: "사원번호", field: "empCode"},
				{headerName: "사원이름", field: "empName"},
				{headerName: "파견일", field: "dispatchDate", width: "200px"},
				{headerName: "파견직책", field: "dispatchPosition", width: "200px"},
				{headerName: "파견부서", field: "dispatchDept", width: "200px"},
				{headerName: "파견복귀일", field: "dispatchReturnDate", width: "400px"},
			];
			var leave = [
				{headerName: "사원번호", field: "empCode"},
				{headerName: "사원이름", field: "empName"},
				{headerName: "휴직구분", field: "leaveType", width: "400px"},
			...
			$('#historygrid3').children().remove();
			var eGridDiv = document.querySelector('#historygrid3');
			new agGrid.Grid(eGridDiv, gridOptions);
			gridOptions.api.sizeColumnsToFit();
		}
...
<body>
<section id="tabs" class="wow fadeInDown" style="height:700px; width:1100px; text-align: center;">
				...
				<tr>
					<td>
						<table>
							<tr>
								<td>
									<div id="historygrid1" style="height: 250px; width:500px; margin: 15px 20px"
										 class="ag-theme-balham"></div>
								</td>
							</tr>
							<tr>
								<td>
									...
									<div id="historygrid2" style="height: 250px; width:500px; margin: 15px 20px"
										 class="ag-theme-balham"></div>
								</td>
							</tr>
						</table>
					...
					<td>
						<div id="historygrid3" style="height: 500px; width:500px; margin: 10px 5px"
							 class="ag-theme-balham"></div>
					</td>
				</tr>
			</table>
